...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex align-items-stretch">
                    <div class="about-wrap img w-100" style="background-image: url(template/images//about.jpg);">
                        ...
                        <div class="col-md-12 heading-section ftco-animate">
                            ...
                            <div class="d-flex video-image align-items-center mt-md-4">
                                <a href="#" class="video img d-flex align-items-center justify-content-center"
                                    style="background-image: url(template/images//about-2.jpg);">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img" style="background-image: url(template/images//bg_2.jpg);">
                        <div class="overlay"></div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter">
        <div class="img image-overlay" style="background-image: url(template/images//about-3.jpg);"></div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-1.jpg);">
                                <div class="box">
                                    <h2>Ryan Anderson</h2>
                                    <p>Head Engineer</p>
                                </div>
                            ...
                            <div class="back">
                                ...
                                <blockquote>
                                    <p>&ldquo;Even the all-powerful Pointing has no control about the blind texts it is
                                        an almost unorthographic life One day however a small line of blind text &rdquo;
                                    </p>
                                </blockquote>
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-1.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Ryan Anderson <span class="position">Head
                                            Engineer</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-2.jpg);">
                                <div class="box">
                                    <h2>Greg Washer</h2>
                                    <p>Head Engineer</p>
                                </div>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-2.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Greg Washer<span class="position">Head
                                            Engineer</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-3.jpg);">
                                <div class="box">
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-3.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Tony Henderson <span
                                            class="position">Ass. Engineer</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-4.jpg);">
                                <div class="box">
                                    <h2>Jack Smith</h2>
                                    <p>Architect</p>
                                </div>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-4.jpg" alt="">
                                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-5.jpg);">
                                <div class="box">
                                    <h2>Ryan Anderson</h2>
                                    <p>President</p>
                                </div>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-5.jpg" alt="">
                                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-6.jpg);">
                                <div class="box">
                                    <h2>Greg Washer</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-6.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Greg Washer<span class="position">Chief
                                            Executive Officer</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-7.jpg);">
                                <div class="box">
                                    <h2>Tony Henderson</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-7.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Tony Henderson <span
                                            class="position">Contractor Operation Head</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="block-2 ftco-animate">
                        <div class="flipper">
                            <div class="front" style="background-image: url(/template/images//team-8.jpg);">
                                <div class="box">
                                    <h2>Jack Smith</h2>
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    <div class="image align-self-center">
                                        <img src="template/images//team-8.jpg" alt="">
                                    </div>
                                    <div class="name align-self-center ml-3">Jack Smith <span class="position">Chief
                                            Financial Officer</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
