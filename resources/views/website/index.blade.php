...
<body>
    ...
    <section class="hero-wrap js-fullheight" style="background-image: url('template/images//bg_1.jpg');"
                ...
                <div class="col-lg-6 ftco-animate">
                    <div class="mt-5">
                        ...
                        <p><a href="#" class="btn btn-primary">Our Services</a> <a href="#"
                                class="btn btn-white" data-toggle="modal" data-target="#exampleModalCenter">Request A
                                Quote</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="services-wrap ftco-animate">
                        <div class="img" style="background-image: url(template/images//services-1.jpg);"></div>
                        <div class="text">
                ...
                <div class="col-md-4">
                    <div class="services-wrap ftco-animate">
                        <div class="img" style="background-image: url(template/images//services-2.jpg);"></div>
                        <div class="text">
                ...
                <div class="col-md-4">
                    <div class="services-wrap ftco-animate">
                        <div class="img" style="background-image: url(template/images//services-3.jpg);"></div>
                        <div class="text">
                            <div class="icon"><span class="flaticon-hammer"></span></div>
                            <h2>Construction</h2>
                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="project">
                        <a href="template/images//project-1.jpg" class="img image-popup d-flex align-items-center"
                            style="background-image: url(template/images//project-1.jpg);">
        ...
        <div class="container">
            ...
            <div class="row d-flex">
                <div class="col-lg-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('template/images//image_1.jpg');">
                        </a>
                        <div class="text d-block">
                            ...
                            <h3 class="heading"><a href="#">Best for any industrial &amp; business solution</a>
                            </h3>
                ...
                <div class="col-lg-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('template/images//image_2.jpg');">
                        </a>
                        <div class="text d-block">
                            <div class="meta">
                                <p>
                ...
                <div class="col-lg-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url('template/images//image_3.jpg');">
                        </a>
                        <div class="text d-block">
                            <div class="meta">
                                <p>
